...
$(window).load(function(){
	...
	$('.gallery').each(function(){
		...
		var mikeUrlList = $('#mikeUrlList').clone(true);
		$(''+sectionId+' .gallery-filter').append(mikeUrlList);
		$(''+sectionId+' #mikeUrlList').css('display','block');
		var $container = $(''+sectionId+' .gallery-items'),
			$select = $(''+sectionId+' .gallery-filter select');
		$container.isotope({
			filter: '.'+$(this).attr('id')
		});
		$container.isotope({
			itemSelector: ''+sectionId+' .gallery-item'
		});
